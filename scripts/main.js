...
const translations = {
  es: {
    ...
    'status.recent':   'Últimas novedades · v0.2.0',

    'cl.added':   'Añadido',
    'cl.changed': 'Mejorado',
    'cl.fixed':   'Arreglado',
    'cl.1': 'Sistema de campeones y meta: catálogo, páginas, progresión y estadísticas',
    'cl.2': 'Scrims y redes sociales V1: planifica scrims y publica posts desde el juego',
    'cl.3': 'Auto-updater: actualizaciones automáticas integradas en la app',
    'cl.4': 'Velocidades de simulación x8 y x12 disponibles',
    'cl.5': 'Delegación de entrenamientos al entrenador asistente',
    'cl.6': 'Migración completa del motor de juego a LoL: roles, atributos y arena',
    'cl.7': 'Mejoras masivas de UI/UX en perfiles, scouting, transferencias y finanzas',
    'cl.8': 'Soporte de idioma turco',
    'cl.9': 'Correcciones en scouting, pantalla de resultados y carga de imágenes',
  ...
  en: {
    ...
    'status.recent':   'Latest highlights · v0.2.0',

    'cl.added':   'Added',
    'cl.changed': 'Improved',
    'cl.fixed':   'Fixed',
    'cl.1': 'Champions & meta system: catalog, pages, progression and stats',
    'cl.2': 'Scrims & social V1: plan scrims and post social updates from the game',
    'cl.3': 'Built-in auto-updater: automatic updates from within the app',
    'cl.4': 'x8 and x12 match simulation speed options',
    'cl.5': 'Delegate training to assistant coach automatically',
    'cl.6': 'Full game engine migration to LoL: roles, attributes and arena',
    'cl.7': 'Massive UI/UX improvements across profiles, scouting, transfers and finances',
    'cl.8': 'Turkish language support',
    'cl.9': 'Fixes across scouting, result screen and image loading',
